...
export default function AboutPage() {
  return (
    <div className="relative min-h-screen z-0">
      ...
      <Section className="pt-28 sm:pt-36 md:pt-44 lg:pt-48 pb-16 sm:pb-20">
        <div id="about" className="flex flex-col lg:flex-row items-center gap-8 sm:gap-12 lg:gap-8 xl:gap-12 justify-center scroll-mt-28 sm:scroll-mt-32 md:scroll-mt-36">
            {/* Left Content */}
          <div className="w-full lg:w-1/2 max-w-xl mx-auto lg:mx-0 text-center lg:text-left px-4 sm:px-0">
            <div className="inline-flex items-center justify-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 text-blue-400 text-sm font-medium mb-6 animate-fadeIn">
              ...
              <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-4 sm:mb-6">
                <span className="block mb-1 sm:mb-2">Transforming <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-400 to-blue-300">Ideas into</span></span>
                <span className="block mb-1 sm:mb-2"><span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-400 to-blue-300">Digital</span></span>
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-white via-blue-100 to-white">Excellence</span>
              </h1>

            <p className="text-sm sm:text-base md:text-lg text-slate-300/90 mb-6 sm:mb-8 leading-relaxed max-w-xl lg:mx-0 mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 md:gap-4 mb-6 sm:mb-10">
                {[
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4 mt-6 sm:mt-8 lg:justify-start justify-center">
                <a
                  href="/contact"
                ...
                <a
                  href="/projects"
                  className="px-4 sm:px-6 py-2.5 sm:py-3 bg-transparent border border-slate-700/60 hover:border-blue-500/50 text-sm sm:text-base text-slate-300 hover:text-white font-medium rounded-lg transition-all duration-300 flex items-center gap-2"
                >
                  View Portfolio
                </a>
              </div>
            ...
            {/* Right/Image Content */}
          <div className="w-full lg:w-1/2 max-w-[320px] sm:max-w-[360px] lg:max-w-[480px] mx-auto">
              <div className="relative">
              <div className="absolute -inset-3 sm:-inset-4 bg-gradient-to-r from-blue-600/30 via-transparent to-purple-600/30 rounded-2xl blur-lg opacity-50"></div>
              ...
              <div className="relative rounded-xl overflow-hidden border-2 border-slate-700/50 bg-slate-800/20 aspect-[4/5] shadow-xl shadow-blue-900/20">
                ...
                <div className="absolute bottom-0 inset-x-0 p-4 z-20 bg-gradient-to-t from-slate-900/90 via-slate-900/60 to-transparent">
                    <div className="flex justify-between items-center">
                      ...
                      <a href="https://github.com/MuhammadUmarMalik" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-blue-900/40 flex items-center justify-center border border-blue-500/30 hover:bg-blue-800/50 transition-colors hover:scale-110">
                      ...
                      <a href="https://linkedin.com/in/muhammad-umar-malik786" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-blue-900/40 flex items-center justify-center border border-blue-500/30 hover:bg-blue-800/50 transition-colors hover:scale-110">
                          <svg className="w-4 h-4 text-blue-300" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                          </svg>
                        </a>
                      <a href="mailto:umarmalik.cs711@gmail.com" className="w-8 h-8 rounded-full bg-blue-900/40 flex items-center justify-center border border-blue-500/30 hover:bg-blue-800/50 transition-colors hover:scale-110">
              ...
              <div className="absolute right-0 top-[60%] sm:top-1/2 bg-gradient-to-r from-blue-600/90 to-blue-800/90 px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-lg border border-blue-500/40 shadow-lg shadow-blue-500/20 backdrop-blur-sm text-white text-xs sm:text-sm font-medium transform rotate-6 animate-float">
              ...
              <div className="absolute left-0 top-[20%] sm:top-1/4 bg-gradient-to-r from-purple-600/90 to-purple-800/90 px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-lg border border-purple-500/40 shadow-lg shadow-purple-500/20 backdrop-blur-sm text-white text-xs sm:text-sm font-medium transform -rotate-6 animate-float" style={{animationDelay: "1s"}}>
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
