...
export default function BlogPostPage({ params }: Props) {
  ...
  const blogPostingJsonLd = {
    ...
    url: postUrl,
    wordCount: Math.max(1, post.content.split(/\s+/).length)
  };
                        ...
                        <div className="relative flex flex-col sm:flex-row items-center sm:items-start gap-8">
                          ...
                          <div className="flex-1 text-center sm:text-left">
                            ...
                            <div className="mt-5 flex flex-wrap items-center justify-center sm:justify-start gap-3">
                              <a href="https://github.com/MuhammadUmarMalik" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 px-4 py-1.5 rounded-full text-sm font-medium bg-slate-800/70 hover:bg-blue-900/30 text-slate-300 hover:text-blue-300 transition-colors border border-slate-700/60 hover:border-blue-500/50">
                              ...
                              <a href="https://linkedin.com/in/muhammad-umar-malik786" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 px-4 py-1.5 rounded-full text-sm font-medium bg-slate-800/70 hover:bg-blue-900/30 text-slate-300 hover:text-blue-300 transition-colors border border-slate-700/60 hover:border-blue-500/50">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="relative bg-gradient-to-br from-slate-900/90 to-slate-950/90 backdrop-blur-md p-8 sm:p-10 rounded-xl border border-slate-800/50 overflow-hidden">
                      ...
                      <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-8">
                        ...
                        <div className="flex-shrink-0 w-full md:w-auto">
                          <NewsletterForm 
                            inputClassName="w-full px-5 py-3 rounded-lg bg-slate-800/70 border border-slate-700/50 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50"
                            buttonClassName="flex-shrink-0 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-medium transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20 border border-blue-500/30"
